...
function(_, BaseView, PostModel, mainTemplate, editTemplate, deleteTemplate) {
  ...
  return BaseView.extend({
     ...
     * all we have to do is save it in this view and pass it to the serialize 
     * method.
     */
     ...
     *
     * Displays the PostEditTemplate, and captures the result of the form, 
     ...
     *
     * Displays the PostDeleteTemplate, and captures the submit action of the 
